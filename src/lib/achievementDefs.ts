...
export const achievementDefs: Achievement[] = [
  ...
  { id: 'graduate', title: 'Graduate', description: 'Complete all 5 lessons', icon: '🎓', kind: 'lessons', threshold: 5 },
  ...
  { id: 'maxed-out', title: 'Maxed Out', description: 'Earn all 150 XP', icon: '💎', kind: 'xp', threshold: 150 },
